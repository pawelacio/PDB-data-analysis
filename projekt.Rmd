...
<ol>
  ...
  <li>Do rozwi¹zania zadania klasyfikacji wykorzysta³em algorytm randomForest *rf* z paczki caret. Trenowania dokonano korzystaj¹c z K-fold cross-validation, gdzie K wynosi 2 natomiast liczba powtórzeñ 5. </li>
</ol>
...
plot_2 <- ggplot(data_top_res_names, aes(local_res_atom_non_h_electron_sum)) +
  ...
  xlab("wartoœæ") +
  ylab("liczba") +
  ggtitle("Rozk³ad liczby elektronów")
...
p <- ggplot(meltData, aes(x="", value)) + 
  ...
  ggtitle("Rozk³ad wartoœci dla kolumn part_01")
